...
export class GitHubCopilotProvider implements IAIProvider {
  ...
  constructor() {
    ...
    const promptPath = path.join(
      __dirname,
      '../../../prompt/product-discovery-prompt.txt'
    );
  ...
  private async callCopilotAPI(prompt: string): Promise<string> {
    ...
    if (!token) {
      console.warn(
        'GitHub token not configured. Using mock response for development.'
      );
  ...
  private generateMockResponse(prompt: string): string {
    ...
    if (isPortuguese) {
      return JSON.stringify({
        ...
        solution:
          'Desenvolvimento de solução integrada que otimiza processos, melhora experiência do usuário e gera valor mensurável através de automação, analytics e interface intuitiva.',
        epics: [
          {
            id: uuidv4(),
            name: 'Autenticação e Controle de Acesso',
            description:
              'Implementar sistema robusto de autenticação e autorização com múltiplos níveis de permissão, garantindo segurança e conformidade.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Criar interface centralizada com métricas, KPIs e visualizações que permitam tomada de decisão informada em tempo real.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Permitir administração completa de usuários, perfis, permissões e grupos, com interface amigável e auditoria completa.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Desenvolver camada de integração robusta que permita comunicação segura com sistemas externos e terceiros.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Implementar sistema centralizado de notificações via email, SMS, push e in-app, com preferências do usuário e templates customizáveis.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Oferecer capacidade de busca rápida e precisa com filtros avançados, melhorando a descoberta de informações e eficiência do usuário.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Fornecer capacidade analítica avançada com relatórios customizáveis, insights automáticos e exportação de dados.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Estabelecer suite completa de testes automatizados que garanta qualidade, reduza regressões e acelere entregas.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Registrar todas as ações críticas do sistema para fins de auditoria, compliance e troubleshooting.',
            requirements: [
      ...
      return JSON.stringify({
        ...
        solution:
          'Development of an integrated solution that optimizes processes, improves user experience, and generates measurable value through automation, analytics, and intuitive interface.',
        epics: [
          {
            id: uuidv4(),
            name: 'Base Architecture Setup',
            description:
              'Establish the technical foundation of the system, including infrastructure, code standards, CI/CD, and environments. Ensures scalability, maintainability, and quality from the start.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Implement secure multi-factor authentication and role-based access control (RBAC), ensuring security and compliance.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Create centralized interface with metrics, KPIs, and visualizations enabling real-time informed decision-making.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Enable complete user administration, profiles, permissions, and groups with user-friendly interface and full audit trail.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Develop robust integration layer enabling secure communication with external systems and third parties.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Implement centralized notification system via email, SMS, push, and in-app, with user preferences and customizable templates.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Offer fast and accurate search capability with advanced filters, improving information discovery and user efficiency.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Provide advanced analytical capability with customizable reports, automatic insights, and data export.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Establish complete automated test suite ensuring quality, reducing regressions, and accelerating deliveries.',
            requirements: [
          ...
          },
          {
            ...
            description:
              'Record all critical system actions for audit, compliance, and troubleshooting purposes.',
            requirements: [
